    ...
    <MarketingShell>
      <main id="main-content" className={marketingMain}>
        ...
        <RetentionSection
          ...
          cta={{ href: "/login", label: t("retentionCta") }}
          tone="default"
        />
        ...
        <PricingSection
          ...
          plans={buildParentsPricingPlans(pricing)}
          footnote={pricing("pricingFootnote")}
          tone="muted"
        />
        ...
        <ConversionCta
          ...
          primaryCta={{ href: "/sign-up?intent=parent", label: t("conversionPrimaryCta") }}
          secondaryCta={{ href: "/login", label: t("conversionSecondaryCta") }}
          tone="soft"
        />
        ...
        <ReferralSection
          ...
          note={t("referralNote")}
          cta={{
            href: "mailto:hello@anchor.care?subject=ANCHOR%20parent%20referral",
            label: t("referralCta"),
          }}
          tone="default"
        />
        ...
        <ConversionCta
          ...
          primaryCta={{ href: "/sign-up?intent=parent", label: t("finalCtaPrimary") }}
